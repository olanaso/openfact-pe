...
public enum TipoComprobante {
    ...
    FACTURA("01", "FACTURA ELECTRONICA", "^[F]{1}\\d{1,3}[-]\\d{1,8}$", 13, true),
    BOLETA("03", "BOLETA ELECTRONICA", "^[B]{1}\\d{1,3}[-]\\d{1,8}$", 13, true),
    NOTA_CREDITO("07", "NOTA DE CREDITO ELECTRONICA", "^[F]{1}\\d{1,3}[-]\\d{1,8}$", 13, false),
    NOTA_DEBITO("08", "NOTA DE DEBITO ELECTRONICA", "^[F]{1}\\d{1,3}[-]\\d{1,8}$", 13, false),
