...
@XmlType(name = "SUNATPerceptionInformationType", propOrder = { "sunatPerceptionAmount", "sunatPerceptionDate",
		"sunatNetTotalCashed", "exchangeRate" })
public class SUNATPerceptionInformationType {
	...
	public AmountType setSunatNetTotalCashed(@Nullable final BigDecimal valueParam, @Nullable final String currencyID) {
