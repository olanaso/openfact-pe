...
@NamedQueries({
		@NamedQuery(name = "getAllSendEventsByPerception", query = "select i from PerceptionSendEventEntity i join i.perceptions a where a.id = :perceptionId order by i.createdTimestamp") })
