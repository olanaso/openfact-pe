    ...
    public Document sign(Document document, OrganizationModel organizacion) {
        ...
        try {
            ...
            DOMSignContext signContext = new DOMSignContext(
                    keystore.getActiveKey(organizacion).getPrivateKey(), newdocument.getDocumentElement());
            ...
            if ((idReference != null) && (elementParent.getElementsByTagName("ds:Signature") != null)) {
                Element elementSignature = (Element) elementParent.getElementsByTagName("ds:Signature")
                        .item(0);
