...
public class SunatUBLCreditNoteProvider implements UBLCreditNoteProvider {
    ...
    public UBLSender<CreditNoteModel> sender() {
        return new UBLSender<CreditNoteModel>() {
            ...
            @Override
            public SendEventModel sendToCustomer(OrganizationModel organization, CreditNoteModel creditNoteModel) throws SendException {
                return null;
            }

            @Override
            public SendEventModel sendToCustomer(OrganizationModel organization, CreditNoteModel creditNoteModel, SendEventModel sendEvent) throws SendException {
                return null;
            }

            @Override
            public SendEventModel sendToThirdParty(OrganizationModel organization, CreditNoteModel creditNoteModel) throws SendException {
                return null;
            }
