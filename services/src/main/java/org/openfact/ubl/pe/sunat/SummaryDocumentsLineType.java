...
@XmlType(name = "SummaryDocumentsLineType", propOrder = { "lineID", "documentTypeCode", "id", "documentSerialID",
		"startDocumentNumberID", "endDocumentNumberID", "accountingCustomerParty", "billingReference",
		"sunatPerceptionDocumentReference", "status", "totalAmount", "billingPayment", "allowanceCharge", "taxTotal" })
public class SummaryDocumentsLineType {
	...
	protected IDType id;
	@XmlElement(name = "DocumentSerialID")
	protected IdentifierType documentSerialID;
	@XmlElement(name = "StartDocumentNumberID")
	protected IdentifierType startDocumentNumberID;
	@XmlElement(name = "EndDocumentNumberID")
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link CustomerPartyType }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link BillingReferenceType }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link SUNATPerceptionDocumentReferenceType
	 *            }
	 * 
	 */
	...
	public AmountType setTotalAmount(@Nullable final BigDecimal valueParam, @Nullable final String currencyID) {
