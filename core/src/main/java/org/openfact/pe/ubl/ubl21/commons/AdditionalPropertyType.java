 ...
 *         &lt;element ref="{urn:oasis:names:specification:ubl21:schema:xsd:CommonBasicComponents-2}Value"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "AdditionalPropertyType", namespace = "urn:sunat:names:specification:ubl21:peru:schema:xsd:SunatAggregateComponents-1", propOrder = {
        "id",
        "name",
        "value"
})
public class AdditionalPropertyType {
    ...
    @XmlElement(name = "Value", namespace = "urn:oasis:names:specification:ubl21:schema:xsd:CommonBasicComponents-2", required = true)
