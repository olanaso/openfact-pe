...
@NamedQueries({
		@NamedQuery(name = "getAllSendEventsBySummaryDocuments", query = "select i from SummaryDocumentsSendEventEntity i join i.summaryDocuments a where a.id = :summaryDocumentsId order by i.createdTimestamp") })
