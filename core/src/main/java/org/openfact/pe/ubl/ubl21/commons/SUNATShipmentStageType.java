 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:oasis:names:specification:ubl21:schema:xsd:CommonBasicComponents-2}ID" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:sunat:names:specification:ubl21:peru:schema:xsd:SunatAggregateComponents-1}ShipmentStageTypeCode" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:oasis:names:specification:ubl21:schema:xsd:CommonBasicComponents-2}TransportModeCode" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:oasis:names:specification:ubl21:schema:xsd:CommonBasicComponents-2}TransportMeansTypeCode" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:sunat:names:specification:ubl21:peru:schema:xsd:SunatAggregateComponents-1}SUNATCarrierParty" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:sunat:names:specification:ubl21:peru:schema:xsd:SunatAggregateComponents-1}SUNATTransportMeans" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:oasis:names:specification:ubl21:schema:xsd:CommonAggregateComponents-2}OriginAddress" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:oasis:names:specification:ubl21:schema:xsd:CommonAggregateComponents-2}DeliveryAddress" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class SUNATShipmentStageType {
    ...
    @XmlElement(name = "TransportModeCode", namespace = "urn:oasis:names:specification:ubl21:schema:xsd:CommonBasicComponents-2")
    ...
    @XmlElement(name = "OriginAddress", namespace = "urn:oasis:names:specification:ubl21:schema:xsd:CommonAggregateComponents-2")
    protected AddressType originAddress;
    @XmlElement(name = "DeliveryAddress", namespace = "urn:oasis:names:specification:ubl21:schema:xsd:CommonAggregateComponents-2")
