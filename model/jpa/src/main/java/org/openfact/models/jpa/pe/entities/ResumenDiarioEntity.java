...
public class ResumenDiarioEntity {
    ...
    @OneToMany(targetEntity = ResumenDiarioLineEntity.class, cascade = { CascadeType.ALL })
    @JoinColumn(name = "SUMMARYLINE_SUMMARYDOCUMENTS")
    protected List<ResumenDiarioLineEntity> SummaryDocumentsLines = new ArrayList<>();
    ...
    @CollectionTable(name = "SUMMARY_REQUERID_ACTION", joinColumns = {
    ...
    public List<ResumenDiarioLineEntity> getSummaryDocumentsLines() {
        return SummaryDocumentsLines;
    }

    public void setSummaryDocumentsLines(List<ResumenDiarioLineEntity> summaryDocumentsLines) {
