...
public class SummaryDocumentSunatResponseProviderFactory  implements UblSenderResponseProviderFactory {
	@Override
	public UblSenderResponseProvider create(OpenfactSession session) {
		return new SummaryDocumentSunatResponseProvider(session);
	}
