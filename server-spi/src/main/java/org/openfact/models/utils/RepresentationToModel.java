...
public class RepresentationToModel {
	...
	public static void updateModel(DocumentReferenceModel model, DocumentReferenceRepresentation rep) {
		...
		if (rep.getCopyIndicator() != null) {
			model.setCopyIndicator(rep.getCopyIndicator());
		}
		if (rep.getUUID() != null) {
		...
		if (rep.getDocumentRepresentation() != null) {
			model.setDocument(rep.getDocumentRepresentation());
		}
		if (rep.getXPath() != null) {
			model.setXPath(rep.getXPath());
		}
		if (rep.getAttachment() != null) {
			updateModel(model.getAttachment(), rep.getAttachment());
		}
	}
