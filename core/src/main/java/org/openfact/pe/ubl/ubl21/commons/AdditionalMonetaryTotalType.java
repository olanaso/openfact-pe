 ...
 *         &lt;element ref="{urn:oasis:names:specification:ubl21:schema:xsd:CommonBasicComponents-2}Name" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:sunat:names:specification:ubl21:peru:schema:xsd:SunatAggregateComponents-1}ReferenceAmount" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:oasis:names:specification:ubl21:schema:xsd:CommonBasicComponents-2}PayableAmount"/&gt;
 *         &lt;element ref="{urn:oasis:names:specification:ubl21:schema:xsd:CommonBasicComponents-2}Percent" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:sunat:names:specification:ubl21:peru:schema:xsd:SunatAggregateComponents-1}TotalAmount" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "AdditionalMonetaryTotalType", namespace = "urn:sunat:names:specification:ubl21:peru:schema:xsd:SunatAggregateComponents-1", propOrder = {
...
public class AdditionalMonetaryTotalType {
    ...
    protected IDType id;
    @XmlElement(name = "Name", namespace = "urn:oasis:names:specification:ubl21:schema:xsd:CommonBasicComponents-2")
    protected NameType name;
    @XmlElement(name = "ReferenceAmount")
    protected AmountType referenceAmount;
    @XmlElement(name = "PayableAmount", namespace = "urn:oasis:names:specification:ubl21:schema:xsd:CommonBasicComponents-2", required = true)
    protected PayableAmountType payableAmount;
    @XmlElement(name = "Percent", namespace = "urn:oasis:names:specification:ubl21:schema:xsd:CommonBasicComponents-2")
     ...
     *
     * @param value allowed object is {@link NameTypeCommBas }
     */
     ...
     *
     * @param value allowed object is {@link BigDecimalCommBas }
     */
     ...
     *
     * @param value allowed object is {@link PayableBigDecimal }
     */
