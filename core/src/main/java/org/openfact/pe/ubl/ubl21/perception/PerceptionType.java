...
@XmlType(name = "PerceptionType", namespace = "urn:sunat:names:specification:ubl21:peru:schema:xsd:Perception-1", propOrder = {
...
public class PerceptionType   implements Serializable, Cloneable {
    ...
    @XmlElement(name = "SUNATPerceptionSystemCode", namespace = "urn:sunat:names:specification:ubl21:peru:schema:xsd:SunatAggregateComponents-1",required = true)
    protected IDType sunatPerceptionSystemCode;

    @XmlElement(name = "SUNATPerceptionPercent",  namespace = "urn:sunat:names:specification:ubl21:peru:schema:xsd:SunatAggregateComponents-1")
    ...
    @XmlElement(name = "SUNATTotalCashed", namespace = "urn:sunat:names:specification:ubl21:peru:schema:xsd:SunatAggregateComponents-1" ,  required = true)
    protected AmountType sunatTotalCashed;

    @XmlElement(name = "SUNATPerceptionDocumentReference",namespace = "urn:sunat:names:specification:ubl21:peru:schema:xsd:SunatAggregateComponents-1")
