...
public class VoidedDocumentsType    implements Serializable, Cloneable{
    ...
    @XmlElement(name = "CustomizationID", namespace = "urn:oasis:names:specification:ubl21:schema:xsd:CommonBasicComponents-2", required = true)
    ...
    protected IDType id;
    @XmlElement(name = "ReferenceDate", namespace = "urn:oasis:names:specification:ubl21:schema:xsd:CommonBasicComponents-2", required = true)
    ...
    @XmlElement(name = "AccountingSupplierParty", namespace = "urn:oasis:names:specification:ubl21:schema:xsd:CommonAggregateComponents-2", required = true)
    protected SupplierPartyType accountingSupplierParty;
    @XmlElement(name = "VoidedDocumentsLine", namespace = "urn:sunat:names:specification:ubl21:peru:schema:xsd:SunatAggregateComponents-1", required = true)
     ...
     * 
     * @param value
     *            allowed object is {@link UBLExtensionsType }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link UBLVersionIDType }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link CustomizationIDType }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link ReferenceDateType }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link SupplierPartyType }
     * 
     */
