...
public class VoidedDocumentsResource {
    ...
    public List<GeneralDocumentRepresentation> getVoidedDocuments(@QueryParam("filterText") String filterText,
    ...
    @NoCache
    @Produces(MediaType.APPLICATION_JSON)
    public Response createVoidedDocument(GeneralDocumentRepresentation rep) {
        ...
        if (documentRep.getSerie() != null && documentRep.getNumero() != null
                && voidedDocumentManager.getVoidedDocumentByDocumentId(
        ...
        try {
            ...
            return ErrorResponse.error("VoidedDocument Created but, Failed to send execute actions email",
